...
// Replace estimated electricity use with verified calculations or API data.
...
export const appliancePresets = [
  ...
  { id: 'gaming-pc', name: 'PC / Computer', icon: '🖥️', estimatedKwh: 0.4, frequency: 'Daily', duration: 180, flexibility: 'fixed', preferredTime: '19:00', earliestTime: '19:00', latestTime: '22:00' },
